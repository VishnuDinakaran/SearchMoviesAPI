...
namespace WebApi_Tests
{
    public class QueryBuilderTests
    {
        ...
        [Fact]
        public void QueryBuilder_Simple_Condition_Test()
        {
        ...
        [Fact]
        public void QueryBuilder_MultiCondition_With_AND_Operator_Test()
        {
            Query query = new Query { PropertyName = "Title", Operator = "Equals", Value = "Rio" };
        ...
        [Fact]
        public void QueryBuilder_MultiCondition_With_Or_Operator_Test()
        {
            Query query = new Query { PropertyName = "Title", Operator = "Equals", Value = "Rio" };
            query.Queries = new List<Query>();
            query.Queries.Add(new Query { Junction = "Or", Index = 1, PropertyName = "Id", Operator = ">", Value = "5" });
        ...
        [Fact]
        public void QueryBuilder_String_Contains_Opertaor_Test()
        {
